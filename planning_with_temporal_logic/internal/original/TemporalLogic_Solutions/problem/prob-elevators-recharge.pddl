(define (problem elevators-time-p8_7_1) (:domain elevators-time)
  ...
  ;;  LTL
    ...
    (not-recharging slow0-0)
    (not-recharging slow1-0)
    (not-recharging fast0)
    (not-recharging fast1)
    
    (= (energy-level slow0-0) 4.0)
    (= (energy-level slow1-0) 4.0)
    (= (energy-level fast0) 4.0)
    (= (energy-level fast1) 4.0)

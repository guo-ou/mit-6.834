(define (domain elevators-time)
  ...
  (:durative-action move-up-slow
                    ...
                    :condition (and
                                ...
                                ;; LTL - PART 2
                                (over all (not-recharging ?lift))
                                (over all (> (energy-level ?lift) 0))
                                )
                    :effect (and
                             ...
                             ;; LTL - PART 2
                             (at end (decrease (energy-level ?lift) 1.0))
                             )
                    )
  ...
  (:durative-action recharge
      ...
      :duration (= ?duration 1.0)
      :condition (at start (< (energy-level ?lift) 4.0))
      :effect (and
               (at start (not (not-recharging ?lift)))
               (at end (not-recharging ?lift))
               (at end (assign (energy-level ?lift) 4.0))
              ))
